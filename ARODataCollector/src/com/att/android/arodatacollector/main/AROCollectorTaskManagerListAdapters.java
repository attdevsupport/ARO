...
/**
 * Represents a custom list adapter for the ARO Data Collector task killer which is used to store list view data.
 * 
 */
public class AROCollectorTaskManagerListAdapters {

	/**
	 * Represents a custom list adapter for the ARO Data Collector task killer that contains a list of processes.
	 */
    public final static class ProcessListAdapter extends BaseAdapter {
    	
    	/** Log TAG string for ARO-Data Collector AROCollectorTaskManagerListAdapters class */
        ...
        /**
         * Initializes a new instance of the AROCollectorTaskManagerListAdapters.ProcessListAdapter class using the specified application context and list of processes.
         * 
         * @param context The application context.
         * @param detailProcesslist An array containing the list of processes.
         * @param mApp The application class to which the list should be added.
         */
        public ProcessListAdapter(AROCollectorTaskManagerActivity context, ArrayList<AROCollectorTaskManagerDetailProcess> detailProcesslist, ARODataCollector mApp) {
            // Cache the LayoutInflate to avoid asking for a new one each time.
            mInflater = LayoutInflater.from(context);
            mAroUtils= new AROCollectorUtils();
            aroActivityManager= (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);;
         ...
         * 
         * @param position The index of the Task Manager item to return.
        ...
        /**
         * Gets the ID of the Task Manager item for the specified index position.
         * 
         * @param position The index of the Task Manager item.
		...
		public void killSelectedTasks() {
			...
			for (int packagecount = 0; packagecount < getCount(); packagecount++) {
				final AROCollectorTaskManagerDetailProcess dp = detailProcesslist
						.get(packagecount);
				if (dp.getSelected()) {
					...
					new Thread(new Runnable() {
						...
						public void run() {
							if (!dp.getPackageName().equals(mContext.getPackageName())){
									killPackage(Integer.toString(dp.getRuninfo().pid),dp.getPackageName());
							}
						}
					}).start();
				}
        ...
        /**
         * Kills the system running task using root shell prompt, which was failed to killed by
         * restartPackage
         * 
         * @param process id to be killed
         */
        ...
        /**
         * Returns a list view for the specified task killer row that contains the specified items. 
         * 
         * @param position The index of the list row.
         * @param convertView The view object containing list row items.
         * @param parent The parent view that the specified view should be added to.
         * @return A View object containing a list of view of the task killer row.
         */
