...
int mp_init_size (mp_int * a, int size)
{
	...
	/* alloc mem */
	a->dp = (mp_digit *)OPT_CAST(mp_digit) XMALLOC (sizeof (mp_digit) * size);
	if (a->dp == NULL) {
		return MP_MEM;
	}
...
int mp_init (mp_int * a)
{
  ...
  a->dp = (mp_digit *)OPT_CAST(mp_digit) XMALLOC (sizeof (mp_digit) * MP_PREC);
  if (a->dp == NULL) {
    return MP_MEM;
  }
...
int mp_grow (mp_int * a, int size)
{
  ...
  if (a->alloc < size) {
     ...
     */
    tmp = (mp_digit*) XREALLOC (a->dp, sizeof (mp_digit) * size);
    if (tmp == NULL) {
