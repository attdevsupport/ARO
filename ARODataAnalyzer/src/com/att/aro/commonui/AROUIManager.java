...
public class AROUIManager extends UIManager {
	...
	public static final Font HEADER_FONT = new Font("Arial Narrow", Font.BOLD,
			20);
	/** The Font style used for ARO Data Analyzer labels. */
	public static Font LABEL_FONT = UIManager.getFont("Label.font").deriveFont(
			Font.BOLD);
	...
	/**
	 * Initializes the AROUIManager with the styles that form the default the look and feel of the ARO Data Analyzer.
	 */
