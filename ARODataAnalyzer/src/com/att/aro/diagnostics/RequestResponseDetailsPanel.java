...
import com.att.aro.main.ContentViewer;
import com.att.aro.main.RequestResponseTableModel;
...
public class RequestResponseDetailsPanel extends JPanel {
	...
	private static final Logger LOGGER = Logger.getLogger(RequestResponseDetailsPanel.class.getName());
	 ...
	 */
	public RequestResponseDetailsPanel(ApplicationResourceOptimizer aro) {
		//this.aro = aro;
		initialize();
	}
