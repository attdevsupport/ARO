...
public class AsyncCheckTableModel extends DataTableModel<AsyncCheckEntry> {
	...
	private static final String[] COLUMNS = { Util.RB.getString("html.asyncload.table.col1"),
											  Util.RB.getString("html.asyncload.table.col2"),
											  Util.RB.getString("html.asyncload.table.col3")};
