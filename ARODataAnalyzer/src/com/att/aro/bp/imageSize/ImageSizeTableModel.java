...
public class ImageSizeTableModel extends DataTableModel<ImageSizeEntry> {
	...
	private static final String[] COLUMNS = { Util.RB.getString("imageSize.table.col1"),
											  Util.RB.getString("imageSize.table.col2"),
											  Util.RB.getString("imageSize.table.col3"),
											  Util.RB.getString("imageSize.table.col4") };
