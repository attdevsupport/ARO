...
public class ByteUtils
{
	 ...
	 */
	public static byte[] getAsUint16NetOrder(int theNumber)
	{
	 ...
	 * @return byte array 
	 */
	public static byte[] getAsUint32NetOrder(int theNumber)
	{
	 ...
	 */
	public static int getByteNetOrderToUint8(byte[] theBytes,int idx)
	{
	 ...
	 */
	public static int getByteNetOrderToUnit16(byte[] theBytes,int idx)
	{
		int sum = 0;
		for (int i=0 ; i<2 ; i++)
		{
	 ...
	 * @return the num (0-65535)
	 */
	public static int getByteLittleEndianUnit16(byte[] theBytes,int idx)
	{
		int sum = 0;
		for (int i=0 ; i<2 ; i++)
		{
	 ...
	 * @return the num 
	 */
	public static long getByteNetOrderToUnit32(byte[] theBytes,int idx)
	{
		long sum = 0;
		for (int i=0 ; i<4 ; i++)
		{
	...
	public static void setLittleIndianInBytesArray(byte[] toPutIn, int startidx, long theNumber, int len){
		...
		for (int i = 0; i < len; i++) {
			toPutIn[i + startidx] = (byte) (number % 256);
			number /= 256;
		}
	}
	 ...
	 */
	public static byte[] extractBytesArray(byte[] from,int stratidx,int targetLen)
 {
		byte[] toReturn = new byte[targetLen];
