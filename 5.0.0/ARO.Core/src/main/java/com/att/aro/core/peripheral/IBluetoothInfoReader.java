 ...
 *
 */
public interface IBluetoothInfoReader {
	List<BluetoothInfo> readData(String directory, double startTime, double traceDuration);
	double getBluetoothActiveDuration();
}
