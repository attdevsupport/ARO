...
/**
 * 	 AROTraceData contains  analyzerResult which is the results of an analyzed trace
 *   bestPracticeResults a List BestPracticeType
 *   success is the analysis error the ErrorCode if success is false
 */
