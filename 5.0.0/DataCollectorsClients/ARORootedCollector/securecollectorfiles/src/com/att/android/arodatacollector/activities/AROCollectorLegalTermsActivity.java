...
import com.att.android.arodatacollector.activities.AROCollectorRestartActivity;
...
public class AROCollectorLegalTermsActivity extends Activity {
	...
	/**
	 * If necessary, push the modified libs onto the device.
	 * If the libs were pushed, go to restart screen.
	...
	private void prepareSecuredCollector() {
		...
		ARODataCollector mApp = (ARODataCollector) getApplication();
