...
public class AROCollectorCustomDialog extends Dialog implements OnKeyListener {
	 ...
	 * 
	 */
	public AROCollectorCustomDialog(Context context, int theme, Dialog_Type type, ReadyListener readyListener, DialogKeyListner listner) {
	...
	private void createAnalyzeLaunchInProgressErrorDialog() {
		...
		final TextView mAroErrorText = (TextView) findViewById(R.id.aro_error_message_text);
		mAroErrorText.setText(R.string.aro_analyzerlaunchinprogress); // ARO Data Collector launch from the Analyzer is already in progress
		final Button buttonOK = (Button) findViewById(R.id.dialog_button_ok);
		buttonOK.setOnClickListener(new OKListener());
	}
	...
	private void createAROInstanceRunningErrorDialog() {
		...
		final TextView mAroErrorText = (TextView) findViewById(R.id.aro_error_message_text);
		mAroErrorText.setText(R.string.aro_aroinstancerunning); // ARO Data Collector instance is already running on the device!
		final Button buttonOK = (Button) findViewById(R.id.dialog_button_ok);
		buttonOK.setOnClickListener(new OKListener());
