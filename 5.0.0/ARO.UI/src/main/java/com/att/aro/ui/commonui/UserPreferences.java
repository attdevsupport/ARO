...
/**
 * A class used to store user preferences for the Data Analyzer, like profile
 * details, visible plots, and the default directory path.
 */
public class UserPreferences {
	 ...
	 * 
	 * @param tdPath
	 *            The absolute path of the last trace directory.
	 */
	...
	/**
	 * Returns either the name or the absolute path to the last used profile of
	 * the specified type. If no type is specified, the name or path to the last
	 * used profile of any type is returned.
	 * 
	 * @param profileType
	 *            Specifies the profile type to return. If null, the last
	 *            profile of any type is returned.
	 ...
	 * 
	 * @param profile
	 *            The profile that is to be set as the last profile.
	 */
	 ...
	 * 
	 * @param profilePath
	 *            The absolute path of the last profile directory.
	 */
	public void setLastProfileDirectory(File profilePath) {
		...
		prefs.put(PROFILE_PATH, profilePath != null ? profilePath.getAbsolutePath() : null);
	}
	...
	public List<ChartPlotOptions> getChartPlotOptions() {
		String chartPlotsOptionPrefsString = prefs.get(CHART_PLOT_OPTIONS, null);
	 ...
	 * 
	 * @param f
	 *            The last table export directory. If this parameter is a file,
	 *            the parent directory is used. If it is null, the previous user
