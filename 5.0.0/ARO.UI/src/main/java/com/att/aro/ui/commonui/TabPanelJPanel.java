 ...
 *
 */
public abstract class TabPanelJPanel extends JPanel implements Observer, IUITabPanelLayoutUpdate {
	private static final long serialVersionUID = 1L;

	private final TabPanelSupport tabPanelSupport;

	public TabPanelJPanel(){
		tabPanelSupport = new TabPanelSupport(this);
	}
	public TabPanelJPanel(boolean alwaysLoad) {
		tabPanelSupport = new TabPanelSupport(this, alwaysLoad);
	}
