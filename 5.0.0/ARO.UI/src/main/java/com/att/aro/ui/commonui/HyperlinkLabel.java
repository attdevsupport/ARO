...
public class HyperlinkLabel extends JLabel {
		...
		addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent mEvent) {
				for (ActionListener al : getActionListeners()) {
					al.actionPerformed(new ActionEvent(HyperlinkLabel.this, mEvent
							.getID(), getName()));
				}
			}
	...
	public void addActionListener(ActionListener aListener) {
		listenerList.add(ActionListener.class, aListener);
	}
	...
	public void removeActionListener(ActionListener aListener) {
		listenerList.remove(ActionListener.class, aListener);
	}
