...
import com.att.aro.ui.view.menu.view.FilterIpAddressesTableModel.AppIPAddressSelection;
...
public class FilterIpAddressesTableModel extends DataTableModel<AppIPAddressSelection> {
	...
	private static final String[] columns = {
		ResourceBundleHelper.getMessageString(DialogItem.filter_select),
		ResourceBundleHelper.getMessageString(DialogItem.filter_app),
		ResourceBundleHelper.getMessageString(DialogItem.tcp_domain),
		ResourceBundleHelper.getMessageString(DialogItem.filter_ip),
		ResourceBundleHelper.getMessageString(DialogItem.filter_color)
	};
