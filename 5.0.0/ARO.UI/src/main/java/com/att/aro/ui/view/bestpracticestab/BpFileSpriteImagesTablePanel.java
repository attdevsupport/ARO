...
import com.att.aro.ui.model.bestpractice.SpriteImageTableModel;

/**
 * @author Barry Nelson
 *
 */
public class BpFileSpriteImagesTablePanel extends AbstractBpDetailTablePanel {

	private static final long serialVersionUID = 1L;

	int noOfRecords;
	
	public BpFileSpriteImagesTablePanel() {
		super();
	...
	@Override
	void initTableModel() {
		tableModel = new SpriteImageTableModel();
	}
	...
	public void setData(Collection<SpriteImageEntry> data) {
		...
		((SpriteImageTableModel)tableModel).setData(data);
		autoSetZoomBtn();
	}
