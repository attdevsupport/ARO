...
/**
 * The DateFormatRenderer class is used to render date/time values in a table
 * that is formatted according to the provided pattern.
 */

public class DateFormatRenderer extends DataTableCellRenderer {
	private static final long serialVersionUID = 1L;

	private SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy hh:mm:ss aa");

	/**
	 * Initializes a new instance of the DateFormatRenderer class using the
	 * default formatter.
	 * 
	 */
	 ...
	 */
	public DateFormatRenderer(SimpleDateFormat formatter) {
		super();
