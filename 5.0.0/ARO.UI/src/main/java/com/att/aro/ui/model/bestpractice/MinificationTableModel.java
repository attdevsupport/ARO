 ...
 * class implements the aro.commonui.DataTableModel class using
 * MinificationEntry objects.
 */
public class MinificationTableModel extends DataTableModel<MinificationEntry> {
	...
	private static final String[] COLUMNS = { 
		ResourceBundleHelper.getMessageString("minification.table.col1")
		, ResourceBundleHelper.getMessageString("minification.table.col2")
		, ResourceBundleHelper.getMessageString("minification.table.col3")
		, ResourceBundleHelper.getMessageString("minification.table.col4")
		, ResourceBundleHelper.getMessageString("minification.table.col5") };
	...
	protected Object getColumnValue(MinificationEntry item, int columnIndex) {
		...
		case COL_3:
			return item.getSavingPercentage();
		case COL_4:
			return item.getSavingsSizeInByte();
		case COL_5:
