...
import com.att.aro.ui.model.bestpractice.FileOrderTableModel;

/**
 * @author Barry Nelson
 *
 */
public class BpHtmlFileOrderTablePanel extends AbstractBpDetailTablePanel {

	private static final long serialVersionUID = 1L;

	int noOfRecords;
	
	public BpHtmlFileOrderTablePanel() {
		super();
	...
	public void setData(Collection<FileOrderEntry> data) {
		...
		((FileOrderTableModel)tableModel).setData(data);
		autoSetZoomBtn();
	}
