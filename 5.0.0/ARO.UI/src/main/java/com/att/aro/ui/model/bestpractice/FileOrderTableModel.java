...
public class FileOrderTableModel extends DataTableModel<FileOrderEntry> {
	...
	private static final String[] COLUMNS = {
			ResourceBundleHelper.getMessageString("html.fileorder.table.col1"),
			ResourceBundleHelper.getMessageString("html.fileorder.table.col2"),
			ResourceBundleHelper.getMessageString("html.fileorder.table.col3") };
