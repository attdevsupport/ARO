...
public class Http4xx5xxStatusResponseCodesTableModel extends DataTableModel<Http4xx5xxStatusResponseCodesEntry>{
	...
	private static final String[] COLUMNS = {
		ResourceBundleHelper.getMessageString("connections.http4xx5xx.table.col1"),
		ResourceBundleHelper.getMessageString("connections.http4xx5xx.table.col2"),
		ResourceBundleHelper.getMessageString("connections.http4xx5xx.table.col3"),
		ResourceBundleHelper.getMessageString("connections.http4xx5xx.table.col4")};
